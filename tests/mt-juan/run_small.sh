...
declare -ar EXPECTED_EXEC_TIMES_us=( "319" "30") # "20 3900 69400" "600000") # cloudlab server
declare -ar DEADLINE_TO_EXEC_RATIOs=("500" "500" "500" "500" "5000") # "50000 5000 5000" "500") # percentage
...
declare -ar ARGS=("input-resize-two/536_64x64.jpg" "input-ekf") # "10 30 36" "input-cnn")
