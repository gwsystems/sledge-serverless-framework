...
# Tenant configs:
# declare -ar TENANT_IDS=("cifar10" "gocr" "lpd" "resize" "ekf") # "bw" "cnn")
# declare -ar INIT_PORTS=(15000 20000 25000 30000 35000) # 35000 10000)
# declare -ar ROUTES=("cifar10" "gocr" "lpd" "resize" "ekf") # "fib10 fib30 fib36" "cnn")
declare -ar TENANT_IDS=("resize" ) # "bw" "cnn")
declare -ar INIT_PORTS=( 30000 35000) # 35000 10000)
declare -ar ROUTES=( "resize" "ekf") # "fib10 fib30 fib36" "cnn")
declare -ar MTDS_REPL_PERIODS_us=(0 0 0 0 0)
declare -ar MTDS_MAX_BUDGETS_us=(0 0 0 0 0)
declare -ar MTDBF_RESERVATIONS_p=(20 30 10 30 0)

# Per route configs:
# declare -ar WASM_PATHS=("$CIFAR10" "$GOCR" "$LPD" "$RESIZE" "$EKF") # "$FIBONACCI $FIBONACCI $FIBONACCI" "$CNN")
# declare -ar RESP_CONTENT_TYPES=("text/plain" "text/plain" "text/plain" "image/jpeg" "application/octet-stream") # "text/plain text/plain text/plain" "text/plain")
# declare -ar EXPECTED_EXEC_TIMES_us=("4000" "8900" "16700" "62000" "30") # "20 3900 69400" "600000") # cloudlab server
# declare -ar DEADLINE_TO_EXEC_RATIOs=("500" "500" "500" "500" "5000") # "50000 5000 5000" "500") # percentage
declare -ar WASM_PATHS=("$RESIZE" "$EKF") # "$FIBONACCI $FIBONACCI $FIBONACCI" "$CNN")
declare -ar RESP_CONTENT_TYPES=("image/jpeg" "application/octet-stream") # "text/plain text/plain text/plain" "text/plain")
declare -ar EXPECTED_EXEC_TIMES_us=( "88578" "30") # "20 3900 69400" "600000") # cloudlab server
declare -ar DEADLINE_TO_EXEC_RATIOs=("500" "500" "500" "500" "5000") # "50000 5000 5000" "500") # percentage
...
declare -ar ARGS=("input-resize-two/113_1024x1024.jpg" "input-ekf") # "10 30 36" "input-cnn")
...
declare -ar LOADS=(? 30 10 30 2) # "3 100 100" "10") # 4.4 for lab server
...
declare -ar VARYING=(10 15 20 25 30 35 40 45 50 55 60 65 70)
