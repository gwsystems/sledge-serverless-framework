...
local_runqueue_minheap_preempt(ucontext_t *user_context)
{
	 ...
	 */
	if (global_deadline >= local_deadline) goto local_is_priority;

	/* Try to pull higher priority sandbox and  */
	...
	if (return_code != 0) goto err_unable_to_get_request;
