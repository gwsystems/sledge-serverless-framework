...
typedef uint32_t (*local_runqueue_try_add_and_get_len_fn_t_idx)(int index, struct sandbox *, bool *need_interrupt);
typedef uint64_t (*local_runqueue_try_add_and_get_load_fn_t_idx)(int index, struct sandbox *, bool *need_interrupt);
...
struct local_runqueue_config {
	...
	local_runqueue_try_add_and_get_len_fn_t_idx try_add_and_get_len_fn_t_idx;
	local_runqueue_try_add_and_get_load_fn_t_idx try_add_and_get_load_fn_t_idx;
...
uint32_t        local_runqueue_add_and_get_length_index(int index, struct sandbox *, bool *need_interrupt);
uint64_t        local_runqueue_add_and_get_load_index(int index, struct sandbox *, bool *need_interrupt);
