/*
 * Note: This file was originally auto-generated by the WASI witx spec
 ...
 * implementation, at this point, the offset has been converted into a native
 * pointer. However, the length information is propagated forward. Additionally,
 * all WASI context is passed as the first argument. This is a pointer to an abstract
 ...
 *      i32 path_len);
 *
 * These techniques are broadly inspired by uvwasi.
 *
 * TODO: Write custom logic to generate this header from the *.witx spec. This could
 * simplify evolution beyond snapshot 1.
 */
